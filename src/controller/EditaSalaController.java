...
public class EditaSalaController implements Initializable {
    ...
    public void redebeSala(Sala sala){
        idSala.setText(sala.getIdSala().toString());
        txtCapacidade.setText(sala.getCapacidade().toString());
    }
